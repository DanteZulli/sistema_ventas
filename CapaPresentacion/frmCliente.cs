...
namespace CapaPresentacion
{
    public partial class frmCliente : Form
    {
        ...
        public frmCliente()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtNumDocumento, "Ingrese el num documento del Cliente");
        }
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.dtpFecha.Value = Convert.ToDateTime(this.dataListado.CurrentRow.Cells["fecha_nacimiento"].Value);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NCliente.Insertar(this.txtNombre.Text.Trim().ToUpper(),this.txtApellidos.Text.Trim().ToUpper(), this.cboSexo.Text,dtpFecha.Value, cboTipoDocumento.Text, txtNumDocumento.Text, txtDireccion.Text, txtTelefono.Text, txtEmail.Text);
                    }
                    else //Si no es nuevo, es editar
                    {
                        rpta = NCliente.Editar(Convert.ToInt32(this.txtIdcliente.Text), this.txtNombre.Text.Trim().ToUpper(), this.txtApellidos.Text.Trim().ToUpper(), this.cboSexo.Text, dtpFecha.Value, cboTipoDocumento.Text, txtNumDocumento.Text, txtDireccion.Text, txtTelefono.Text, txtEmail.Text);
                    }
